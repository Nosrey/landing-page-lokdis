        ...
        <div className={styles.blockFiveContainer}>
            ...
            <div className={styles.container} >
                <div className={styles.containerLetter} >
                    ...
                    {language === 'spanish' ? <p className={styles.paragraph}> <span style={{ color: 'white', }} > ¡Únete a la lista de espera y sé una de las primeras personas </span><br></br> <span className={styles.colorCyanBackground}> en tener acceso a esta </span> <span className={styles.colorCyanBackgroundTwo} > comunidad! </span> </p> : <p className={styles.paragraph}> <span style={{ color: 'white', }} > Join the waiting list and be among the first people</span><br></br> <span className={styles.colorCyanBackground}> to have access to this</span> <span className={styles.colorCyanBackgroundTwo} > community! </span> </p>}
